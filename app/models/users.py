...
def authenticate_user(email: str, password: str) -> Optional[User]:
    with db.database.db.connect() as connection:
        ...
        if not user.is_active: raise ValueError("Account deactivated, please contact support.")
        if user.password_hash == hash_password(password, user.password_salt): return user
    return None
